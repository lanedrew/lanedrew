...
My research is centered on statistical methods for analyzing complex spatial and temporal data, particularly in ecological and environmental settings. I am particularly interested in:

-   Bayesian Methods and Non-Linear Regression – Implementing Bayesian hierarchical models and non-linear regression techniques for parameter estimation and uncertainty quantification.

-   Record Linkage and Data Integration – Developing probabilistic methods for linking spatial-temporal datasets across different resolutions and time points.
